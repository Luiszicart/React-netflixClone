const requests = {
  ...
  fetchTopRated: `/movie/top_rated?api_key=${process.env.REACT_APP_API_KEY}&languaje=en-us`,
  ...
  fetchRomaceMovies: `/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&with_genres=10749`,
